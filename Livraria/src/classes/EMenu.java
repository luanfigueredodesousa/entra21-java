...
public enum EMenu implements IMenu{
    ...
    ADICIONAR_ESTANTE(5,"Adicionar itens na estante" );
    ...
    /**
     * Retorna uma opção de menu de acordo com o que o vier no parametro
     * @param escolha = inteiro referente ao valor da opção do menu
     * @return A opção de menu escolhido ou null
     */
    ...
    public int getValorOpcao() { return this.valorOpcao;}
