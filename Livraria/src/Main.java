...
//Coeso - Faz oq tem que fazer
//Aclopado - Depende de muita coisa
//Documentado - JavaDoc (Usando do /* Teste */ OU // - @param @return)
    ...
    public static void main(String[] args) {
        ...
        while (loop) {
            ...
            switch (opcao) {
                ...
                default -> System.out.println("Opção não implementada! - teste");
            }
        }
